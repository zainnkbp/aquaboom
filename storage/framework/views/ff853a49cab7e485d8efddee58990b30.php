<div>
    <div class="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-4">
        ...
        <div class="w-full max-w-md mt-8 text-center">
            <a href="<?php echo e(url('/admin')); ?>" class="inline-flex items-center text-sm font-semibold text-slate-400 hover:text-white transition">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function onScanSuccess(decodedText, decodedResult) {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('processTicket', decodedText);
            }
...
<?php /**PATH /var/www/aquaboom/resources/views/livewire/validator.blade.php ENDPATH**/ ?>