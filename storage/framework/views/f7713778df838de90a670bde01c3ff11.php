  ...
  >
    ...
    >
      <div class="max-w-7xl mx-auto px-6 relative z-50">
        ...
        >
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $wahanas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $wahana): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          >
            <img
              src="<?php echo e($wahana->image_url); ?>"
              alt="<?php echo e($wahana->name); ?>"
              loading="lazy"
            ...
            >
              <div class="w-12 h-1 <?php echo e($color); ?> mb-4 rounded-full"></div>
              <h3 class="text-3xl font-black text-white mb-2"><?php echo e($wahana->name); ?></h3>
              <p
                class="text-slate-200 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100"
              >
                <?php echo e($wahana->description); ?>
...
[$__name, $__params] = $__split('checkout');

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3960376931-0', $__key);
...
<?php /**PATH /var/www/aquaboom/resources/views/welcome.blade.php ENDPATH**/ ?>