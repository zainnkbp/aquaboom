            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-slate-600 text-base font-semibold leading-relaxed mb-12">
                        Misi kami sederhana: menyajikan kebahagiaan tak terlupakan bagi keluarga dan pencinta
                        petualangan dengan komitmen penuh pada aspek kebersihan, keramahan, dan keamanan bintang lima.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center pt-12 border-t border-slate-100">
                        <div>
                            ...
                            <span class="text-xs font-bold text-slate-400 uppercase tracking-widest">World-Class
                                Slides</span>
                        </div>
                        <div>
                            <span class="block text-5xl font-black text-[#3B82F6] mb-2">7th</span>
                            <span class="text-xs font-bold text-slate-400 uppercase tracking-widest">Floor
                                Rooftop</span>
                        </div>
                        <div>
                            <span class="block text-5xl font-black text-aqua-gold mb-2">1</span>
                            <span class="text-xs font-bold text-slate-400 uppercase tracking-widest">Integrated
                                Mall</span>
                        </div>
                    </div>
                </div>
